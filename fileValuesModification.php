...
<html>
    ...
    <body>
		...
		<div class="container">
			...
			<p>This page is a demo of the XMLManipulator tool you can use to edit your XML files directly in your web browser. <a href = "https://github.com/fclerc/XMLManipulator"  target="_blank">Code available on my Github</a></p>
        ...
        $(function(){    
            ...
            manipulateXML(file,'#XMLcontainer', 'modify','', "#currentFileName");
        });
        </script>
    </body>
